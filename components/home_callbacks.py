...
def get_callbacks(app):
    ...
    @app.callback(
        ...
        Input("increase-slider", 'value'),
        # Output({'type': 'text', 'index': ALL}, "children"), 
        # Input({'type': 'text', 'index': ALL}, "id"),
        [Input("pandas-dropdown-2", "value"),
        Input("pandas-dropdown-3", "value"),
    ...
    def create_cards(sliderP, sliderI, valueB, valueM, valueS, children):
        print(sliderP, sliderI)
        dff1 = df1.copy()
        dff2 = df2.copy()
